...
class CheckoutForm extends Component {
    ...
    componentDidMount() {
      ...
      clearForm = () => {
        Alert.success('Your purchase was successful. Asante!')
          this.setState({
              total: 0,
              name: '',
              email: '',
        ...
        return (
            <FlexboxGrid justify="center">
                ...
                <Form>
                    ...
                    <Dropdown value={this.state.country} onChange={(e) => this.changeCountry(e)} title="Country">
                        <Dropdown.Item>Kenya</Dropdown.Item>
                    </Dropdown>
                    </FormGroup>
                    <FormGroup>
                    <Dropdown value={this.state.state} onChange={(e) => this.changeState(e)} title="Town">
                        <Dropdown.Item>Nairobi</Dropdown.Item>
                        <Dropdown.Item>Mombasa</Dropdown.Item>
                        <Dropdown.Item>Kisumu</Dropdown.Item>
                        <Dropdown.Item>Embu</Dropdown.Item>
                        <Dropdown.Item>Voi</Dropdown.Item>
                        <Dropdown.Item>Machakos</Dropdown.Item>
                    </Dropdown>  
                    ...
                    <FormGroup>
                    <ButtonToolbar>
                        <Button onClick={() => this.clearForm()} appearance="primary">Confirm Purchase</Button>
